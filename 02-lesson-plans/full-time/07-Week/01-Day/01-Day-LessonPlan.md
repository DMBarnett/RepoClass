...
* To show the API you can simply go to this link: <http://starwars-express.herokuapp.com/api> (or <http://starwars-express.herokuapp.com/api/characters> to display all characters). The api also accepts an additional parameter at the end of the URL in the form of <http://starwars-express.herokuapp.com/api/characters/charactername>. As an example: <http://starwars-express.herokuapp.com/api/characters/yoda>.
