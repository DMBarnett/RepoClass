...
* Open the Homework-4 solution for TrainTime in the browser. (Alternatively go to <https://train-time-fsf.herokuapp.com/>)
...
* Refer to `08-project-1/04-Stu_Branching-Pushing`, which contains the following instructions:
