# 14.3 Lesson Plan: The Power of the ORM (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
* After five minutes or so, call on random students to share their thoughts regarding the usefulness of ORMs.
...
### 13. Instructor Do: Introduction to the MVC Framework (5 mins)
...
* Have students find examples of an MVC framework for a couple of minutes and discuss what an MVC framework actually is.
