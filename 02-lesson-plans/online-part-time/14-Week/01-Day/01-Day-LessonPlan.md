## 14.1 Lesson Plan: I Can Make an App with Some Handlebars (6:30 PM) <!--links--> &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)
...
### 2. Groups Do: Express Calculator (20 mins)
...
### 5. Groups Do: Seinfeld Application (20 mins)
...
### 9. Students Do: Explaining Lunches Application (10 mins)

* Slack out a zipped version of `04-HandlebarsLunch` to your students, have them open it up, and have them explain how the code functions. Once they are finished going over `main` and `index`, instruct them to look into `all-lunches` in an attempt to figure out how the code in there works as well.
...
### 11. Groups Do: Ben and Jerry's App (15 mins)
...
### 12. Everyone Do: Ben and Jerry's App Review (5 mins)
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=14.01)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=14.01)
