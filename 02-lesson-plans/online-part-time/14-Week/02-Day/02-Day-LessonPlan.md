## 14.2 Lesson Plan: Bringing it from the Front to the Back (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 5. Students Do: Understanding GET, POST, PUT, and DELETE (5 mins)

* Have students think about how they would explain GET, POST, PUT and DELETE as best they can before having four randomly selected students explain to the class what each method does.
...
### 7. Groups Do: Understanding TaskSaver (15 mins)
...
* Have your students go through the code line-by-line with their breakout group members as they work to solidify the lessons learned up above.
...
### 11. Groups Do: Going Over the Day Planner (15 mins)

* Slack out `09-DayPlanner` to your students, have them run the application on their computers, and then have them explain the code to their breakout room partners line-by-line.

### 12. Everyone Do: Watch List (20 mins)

* Once everyone seems to have finished picking their way through the code and you have answered whatever questions your students may have had, bring everyone back together and slack out the following instructions found in `10-WatchList/README.md` file.
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=14.02)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=14.02)
