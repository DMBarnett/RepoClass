## 20.3 Lesson Plan - Review, Homework, Final Projects (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
* Update the project deliverables due dates in the slide deck within the project resources folder.
...
* Start presenting the lecture's Power Point found in the project-resources folder.
...
### 6. Groups Do: Conceptualize the Final App (29 mins)

* When you close the Power Point, have your students form groups and send them to breakout rooms accordingly to think about the app they'll create over the next month.
...
* As they're thinking about their apps, you and the TAs should bounce around breakout rooms and check in on their progress. Once again, make sure they pick something that will challenge them (but not something so ambitious that it will destroy them).

### 7. BREAK (40 mins)

### 8. Groups Do: Finish Conceptualizing And Consider the Next Steps (80 mins)
