# 11.1 Lesson Plan - Hard Hat Zone: Constructors at Work (6:30 PM) <!--links--> &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)
...
* Open up your editor and call upon a couple students at random to code out specific parts of the assignment whilst explaining their logic to the class.

* Run the completed code in Git Bash or terminal and then go over the code line-by-line with the class
...
### 5. Groups Do: Character Creation (30 mins)
...
### 8. Groups Do: Tamagotchi Time (40 mins)

* See if there are any questions and then slack out the following activity

* **Instructions**

  * Remember Tamagotchis? They were those little toys that contained "digital pets" which you could feed, pet, play with, and care for. Kind of like Furbies but a whole lot less terrifying. Over the next forty minutes or so, you are going to create your own basic Tamagotchi clone using constructors.
...
* Ask your class to use the raise hand function if they managed to get their "Digital Pets" to function properly and then call upon some of the more confident students to verbally code out the many different parts of the activity while you do the typing.

  * This activity has a lot of parts to it, so you should be able to get everyone to contribute to code out sections of it. We would recommend having each student tackle at least one method.
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=11.01)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=11.01)
