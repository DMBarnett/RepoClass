## 16.1 Lesson Plan - Test Your Patience (6:30 PM) <!--links--> &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)
...
### 7. Groups Do: Mocha + Chai Documentation, Testing disemvowel (15 min)
...
* **INSTRUCTIONS**:
  ...
  * Your task is to use Chai to write a test suite for `disemvowel`. The catch is that you don't get an implementation yet. First,
    ...
    * With your breakout room partners, determine what a "representative example" of an input to `disemvowel` might be.
  ...
  * When you think you're done, explain to each other why the test you've written totally describes `disemvowel`. Be prepared to explain your test suite to the class.
...
### 9. Groups Do: Test titleize (15 min)
...
### 12. Groups Do: Brainstorm & Project Sketch (70 min)
...
* This approach works best if you bounce between breakout rooms as opposed to holding workshops in the main zoom room.
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=16.01)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=16.01)
