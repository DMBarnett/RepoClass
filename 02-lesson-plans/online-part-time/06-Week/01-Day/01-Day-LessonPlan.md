## 6.1 - Intro to APIs and AJAX (6:30 PM) <!--links--> &nbsp; [⬅️](../../05-Week/03-Day/03-Day-LessonPlan.md) &nbsp; [➡️](../02-Day/02-Day-LessonPlan.md)
...
### 12. Students Do: OMDb API Exploration (10 mins)
...
### 18. Groups Do: AJAX to HTML Activity (15 mins)
...
### 20. Students Do: Giphy Documentation (10 mins)
...
* **Instructions:**
  ...
  * Using the [Giphy API Documentation](https://developers.giphy.com/docs/), try to research answers to the following questions:
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=06.01)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=06.01)
