## 6.2 - Advanced AJAX (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 7. Groups Do: Dynamic Movie Button Layout (25 min)
...
### 9. Groups Do: Log Movie JSON & Click JSON Data Attribute  (20 min)
...
### 12. Groups Do: Complete Working Movie App (25 min)
...
### 14. Groups Do: Bands In Town App (20 min) (Optional)
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=06.02)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=06.02)
