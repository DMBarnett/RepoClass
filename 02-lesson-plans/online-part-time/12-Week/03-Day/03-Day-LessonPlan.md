## 12.3 Lesson Plan - My-Massive-SQL (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
* Today's class is far gentler than the past two have been and should be looked at as a time to help everyone catch up with one-another. Throughout the assignment, you and your TA's should be keeping a close eye on slack and during activities to help those who seem to be struggling.
...
### 2. Groups Do: Examining The Dataset (10 mins)
...
* Now that they have looked through the dataset, prompt them to work in groups to come up with how they might go about creating a database/table for this data.

* After a few minutes of discussion, call the class back together and start asking individuals how they would go about creating a database and table to hold this data.
...
### 4. Groups Do: Preparing the Database (20 mins)
...
* When everyone has finished the assignment, ask for a member of the class to share their `schema.sql` file on slack and walk the class through the logic of their creation.
...
### 7. Groups Do: Importing and Working With Big Data (50 mins)
...
### 10. Groups Do: Two Tables Are Better Than One (60 mins)
...
* Once it seems everyone has an idea of how that code works, ask a few brave souls to share their screens showing their additions to the code with the class. Let them describe their code and field the questions as well, only jumping in when you feel the need to.
