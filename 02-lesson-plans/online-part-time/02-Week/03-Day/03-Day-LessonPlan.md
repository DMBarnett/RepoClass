## 2.3 - Bootstrap Layouts and Responsive Design (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
### 2. Instructor / TA Do: Emotional Monologue (10 mins)
...
* Begin class by going through the slides for building a positive vibe in the class. Use the following points as suggestions for what to say. 
  ...
  * **Help ME Slide:**
    ...
    * Have students use the raise hand function as you ask each of the following questions and lower all hands before moving on to the next question.
...
### 4. Instructor Do: Recap Bootstrap (5 mins)
...
### 7. Instructor Do: Sketching / Grid Layouts (7 mins)
...
* After showing students the solution to this example, the slideshow immediately returns to a "You Try" example. Have them think about the number of rows and columns.

* Then call on a student randomly and ask them to count the number of rows and columns for you.

* Proceed through the more challenging examples using the same approach. In each example, have students think about the number of rows and columns. As you point out the various layouts, note how each wireframe represents a different kind of website (one is a blog, one is a corporate site, one is an image gallery, etc.).
...
### 9. Instructor Do: Grid Design with Bootstrap (10 mins)
...
### 10. Students Do: Containers, Rows, Columns (5 mins)

* Use the slide as a cue to have students think about the relationship between rows, columns, and containers.

* Then call a random student to explain it back to you.

### 11. Instructor Demo: Coding Grids (10 mins)
...
### 12. Instructor Do: Coding Grids (10 mins)
...
### 13. Groups Do: Text Layout Activity (20 mins)
...
### 14. Instructor Do: Review Text Layout Activity (5 mins)
...
### 16. Instructor Demo: Bootstrap Wireframe Layout (15 mins)
...
### 17. Groups Do: Bootstrap Wireframe Activity (30 mins)
...
* **Instructions:**
  ...
  * Working in groups and using Bootstrap CSS make, the following design.
...
### 18. Instructor Do: Review Bootstrap Wireframe Activity (7 mins)
...
### 19. Instructor Do: Common Questions (5 mins)

* Flip to the slide on common questions. Address them as necessary. 

### 20. Instructor Do: Mobile Responsiveness (5 mins)
...
### 21. Instructor Demo: Media Queries (5 mins)
...
### 22. Students Do: Explain Media Queries (2 mins)

* Have students explore the media query code for a few moments.
...
### 23. Groups Do: Build Media Query (15 mins)
...
* Then slack out the following unsolved folder and instructions:

* (`18-StudentMedia > Unsolved`)
...
### 24. Instructor Do: Build Media Query (5 mins)
...
### 25. Instructor Do: Viewport (5 mins)
...
### 26. Students Do: Viewport Activity (5 mins)
...
### 27. Instructor Do: Questions (0 mins)
...
### 28. EXTRA CONTENT: Harder Layout (40 mins)
...
### 29. Slack out this Week's Video Guide (0 mins)
...
### 28. Next Week's Homework (0 mins)
...
[Went Well](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=positive&lesson=02.03)

[Went Poorly](http://www.surveygizmo.com/s3/4325914/FS-Curriculum-Feedback?format=lo&sentiment=negative&lesson=02.03)
