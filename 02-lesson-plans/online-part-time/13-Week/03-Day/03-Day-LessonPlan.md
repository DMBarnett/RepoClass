## 13.3 Lesson Plan - Hot Restaurant Activity (10:00 AM) <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md)
...
* Feel free to open up the `phases.md` file found in `16-HotRestaurant` folder and slack it out.

### 3. Instructor Do: Group Formation + Initial Instructions (10 mins)

* Divide students into breakout groups of 4. 
...
* Let them know that you will be providing them with guidance on how to proceed every 20 minutes or so and to keep an eye on slack!

### 4. Groups Do: Phase I - Pseudocode (15 mins)
...
### 5. Groups Do: Phase II - Frontend + Server Creation (20 mins) (Critical)
...
### 6. Groups Do: Phase III - API Routing + Frontend Delivery (40 mins) (Critical)
...
### 8. Groups Do: Phase IV - Backend Logic + AJAX (60 mins) (High)
...
### 9. Groups Do: Phase V - De-bugging + Bonus (20 mins)
...
* Bring students back from their breakout rooms. Let students know that this was a hard activity but an incredibly realistic one.
