## 13.2 Lesson Plan - Express Yourself (6:30 PM) <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 2.	Instructor Do: Quick Recap "Server" Concepts (5 mins)

* Use the slides to help you guide students through a recap of the concepts behind servers.

### 3.	Everyone Do: Introduce Express (4 mins)
...
### 4.	Instructor Do: Demo basic routing with server1.js (5 mins)
...
### 5.	Students Do: Add Route to server1.js (7 mins)
...
* **Instructions:**
  ...
  * Help those in slack when you're done.

### 6.	Instructor Do: Review Previous Activity (5 mins)
...
### 7.	Students Do: Dissect req.params (5 mins)
...
* **Instructions:**
  ...
  * Then once you have a working server instance, begin to examine the file. Try to explain to yourself what the significance of `/:character` and `req.params.character` is.

  * Create a test case to check your hypothesis.

### 8. Instructor Do: Review Previous Activity (3 mins)
...
### 9.	Students Do: Dissect Parameter Match (5 mins)
...
* **Instructions:**
  ...
  * Examine the code flagged in the comments. Explain what it does and how it works. Be sure to create test cases that confirm your hypothesis.

### 10.	Instructor Do: Review Previous Activity (5 mins)
...
### 11.	Instructor Do: Re-demonstrate Previous Solved Activity (10 mins)
...
### 12.	Instructor Do: Show code for Post Route (7 mins)
...
### 13.	Students Do: req.body dissection (5 mins)
...
### 14.	Instructor Do: Postman Demo (7 mins)
...
### 15.	Students Do: Postman Exercise (10 mins)
...
### 17.	Instructor Do: Demo sendFile (server6.js + view.html)		(10 mins)
...
### 18.	Students Do: Dissect .get view.html (7 mins)
...
* **Instructions:**
  ...
  * Look at the file sent to you then explain what the `res.sendFile` line does. Then try creating a new HTML file and routing to that one instead.

### 19.	Instructor Do: Review Activity (7 mins)
...
### 20.	Instructor Do: Demo Complete Application (6 mins)
...
### 21.	Students Do: Dissect .post (add.html)		(7 mins)
...
* **Instructions:**
  ...
  * Explain what the code does, what its for, and why its relevant to the application so far. Be sure to explain what the `$.post` code is doing.

### 22.	Instructor Do: Review Activity (add.html)	(7 mins)
...
### 23. Instructor Do: Introduce Heroku (4 mins)
...
### 24. Groups Do: Deploy to Heroku (30 mins)
...
* **Instructions:**
  ...
  * Although you'll be working in breakout rooms so you can get help or help those in your groups, every student should be deploying their own application! This is activity is tricky so share your deployed link with the people in your breakout room to make sure it works.
...
* Be sure to bounce around breakout rooms and help students as they hit snags or have problems pushing to heroku, consulting the troubleshooting tips below as needed.
